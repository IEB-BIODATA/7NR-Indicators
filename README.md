  ...
  <tbody>
    ...
    <tr>
      <td>Meta Nacional I.2</td>
       <td><ul><li><a href="./indicadores/3.1_Percentage_protected_area_coverage/">3.1 Coverage of protected areas and other effective area-based conservation measures</a></li><li><a href="./indicadores/Meta_Nacional_I2_planes_de_manejo/">Indicador I2: áreas protegidas con planes de Manejo y Gestión Efectiva</li></li></ul></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><ul><li>2.2 Area under restoration</li><li>3.1 Coverage of protected areas and other effective area-based conservation measures</li><li><a href="./indicadores/I_4_numero_de_especies_clasificadas/">Indicador I4: número de especies clasificadas</li></ul></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li><a href="./indicadores/12.1_Average_Area_Gree_Blue/">12.1 Average share of green/blue space (urban) for public use</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li><a href="./indicadores/Meta_Nacional_I23_Normas_de_Calidad/">Indicador I23: tablas normas de calidad</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li><a href="./indicadores/D_1_international_public_funding/">Indicador D.1 International public funding, including official development assistance (ODA), on conservation and sustainable use of biodiversity</a></li>
