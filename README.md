<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li><a href="./12.1_Average_Area_Gree_Blue/">12.1 Average share of green/blue space (urban) for public use</a></li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li><a href="./D_1_international_public_funding/">Indicador D.1 International public funding, including official development assistance (ODA), on conservation and sustainable use of biodiversity</a></li>
